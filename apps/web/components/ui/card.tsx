...
>(({ className, size = "default", ...props }, ref) => (
  <div
    ...
    data-size={size}
    className={cn(
      "group/card rounded-2xl border bg-card text-card-foreground shadow-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-display text-2xl font-semibold leading-none tracking-tight group-data-[size=sm]/card:text-base",
      className,
    )}
    {...props}
  />
